    ...
    function hb() {
      if (a(s).length && !a(r).length) {
        var b = a(s).outerWidth(),
          ...
          d = a("li.cameracurrent", s).length
            ? a("li.cameracurrent", s).position()
            : "",
        ...
        if (gb == true) {
          a("ul", s).width(
            a("ul > li", s).length * a("ul > li", s).outerWidth()
          );
        ...
        var j = a("li.cameracurrent", s).length ? d.left : "",
          k = a("li.cameracurrent", s).length
            ? d.left + a("li.cameracurrent", s).outerWidth()
            : "";
    ...
    function jb(c) {
      ...
      if (!a(".imgLoaded", m).length) {
        ...
        if (v.length > l + 1 && !a(".imgLoaded", n).length) {
          ...
          n.prepend(
            a(A).attr("class", "imgLoaded").css("visibility", "hidden")
          );
          A.onload = function () {
            q = A.naturalWidth;
            w = A.naturalHeight;
        ...
        a.each(nb, function (c, e) {
          function o() {
            ...
            if (a(".cameraeased", k).length == ab) {
              ...
              if (
                a("> div", j).eq(l).attr("data-video") != "hide" &&
                a(".cameraContent.cameracurrent .imgFake", g).length
              ) {
              ...
              if (c != 0) {
                a(".cameraSlide.cameracurrent .fadeIn", g).each(function () {
                  ...
                  var d = a(this);
                  if (
                    typeof d.attr("data-outerWidth") === "undefined" ||
                    d.attr("data-outerWidth") === false ||
                    d.attr("data-outerWidth") === ""
                  ) {
                    var e = d.outerWidth();
                  ...
                  if (
                    typeof d.attr("data-outerHeight") === "undefined" ||
                    d.attr("data-outerHeight") === false ||
                    d.attr("data-outerHeight") === ""
                  ) {
                    var f = d.outerHeight();
              ...
              L = setInterval(function () {
                ...
                if (h != "pie") {
                  ...
                  db.arc(
                    b.pieDiameter / 2,
                    b.pieDiameter / 2,
                    b.pieDiameter / 2 - b.loaderStroke,
                    0,
                    Math.PI * 2,
                    false
                  );
          ...
          switch (N) {
            ...
            case "stampede":
              ...
              marginTop =
                u * 0.2 * (Math.floor(c / D) + 1 - (C - Math.floor(C / 2))) +
                "px";
              break;
            case "mosaic":
              height = 0;
